...
import (
	...
	apisamplecontrollerv1alpha1 "k8s.io/sample-controller/api/samplecontroller/v1alpha1"
	versioned "k8s.io/sample-controller/client/clientset/versioned"
	internalinterfaces "k8s.io/sample-controller/client/informers/externalversions/internalinterfaces"
	samplecontrollerv1alpha1 "k8s.io/sample-controller/client/listers/samplecontroller/v1alpha1"
)
...
func NewFilteredFooInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&apisamplecontrollerv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisamplecontrollerv1alpha1.Foo{}, f.defaultInformer)
}
