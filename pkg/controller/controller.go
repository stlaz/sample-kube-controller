...
import (
	...
	samplev1alpha1 "k8s.io/sample-controller/api/samplecontroller/v1alpha1"
	clientset "k8s.io/sample-controller/client/clientset/versioned"
	samplescheme "k8s.io/sample-controller/client/clientset/versioned/scheme"
	informers "k8s.io/sample-controller/client/informers/externalversions/samplecontroller/v1alpha1"
	listers "k8s.io/sample-controller/client/listers/samplecontroller/v1alpha1"
)
