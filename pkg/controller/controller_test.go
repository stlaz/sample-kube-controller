...
import (
	...
	samplecontroller "k8s.io/sample-controller/api/samplecontroller/v1alpha1"
	"k8s.io/sample-controller/client/clientset/versioned/fake"
	informers "k8s.io/sample-controller/client/informers/externalversions"
)
